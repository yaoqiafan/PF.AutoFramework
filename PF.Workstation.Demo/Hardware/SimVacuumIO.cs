...
namespace PF.Workstation.Demo.Hardware
{
    ...
    /// 【硬件层示例】模拟真空吸盘IO控制卡
    ///
    /// 继承链：SimVacuumIO → BaseIODevice → BaseDevice → IHardwareDevice
    ///                                              → IIOController
    ///                                              → IAttachedDevice（父板卡关联）
    ///
    /// 端口规划（8输入 / 8输出）：
    ...
    /// </summary>
    public class SimVacuumIO : BaseIODevice
    {
        //public SimVacuumIO(string deviceId, string deviceName, bool isSimulated, ILogService logger) : base(deviceId, deviceName, isSimulated, logger)
        //{
        //}
        ...
        //public override int InputCount  => _inputs.Length;
        //public override int OutputCount => _outputs.Length;
        ...
        ///// </summary>
        //public override bool ReadInput(int portIndex)  => Volatile.Read(ref _inputs[portIndex]);
        //public override bool ReadOutput(int portIndex) => Volatile.Read(ref _outputs[portIndex]);
        ...
        ///// </summary>
        //public override void WriteOutput(int portIndex, bool value)
        //{
        ...
        ///// </summary>
        //public override async Task<bool> WaitInputAsync(int portIndex, bool targetState,
