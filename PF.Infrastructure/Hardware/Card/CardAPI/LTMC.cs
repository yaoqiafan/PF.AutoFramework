...
namespace PF.Infrastructure.Hardware.Card.CardAPI
{
    /// <summary>
    /// 硬件高速比较信息结构体
    /// </summary>
    ...
    /// <summary>
    /// 雷赛控制卡 (LTDMC) 底层 API 封装
    /// </summary>
    public partial class LTDMC
    {
        /// <summary>设置和读取打印模式（适用于所有脉冲/总线卡）</summary>   
...
        // ------------------- 板卡初始和配置函数 -------------------
        /// <summary>初始化控制卡（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>硬件复位（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>关闭控制卡（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>控制卡热复位（适用于EtherCAT、RTEX总线卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_soft_reset(ushort CardNo);
        /// <summary>控制卡冷复位（适用于所有脉冲/总线卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_cool_reset(ushort CardNo);
        /// <summary>控制卡初始复位（适用于EtherCAT总线卡）</summary>
...
        /// <summary>读取控制卡信息列表（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>读取发布版本号（适用于DMC3000/DMC5X10系列脉冲卡、EtherCAT总线卡）</summary>
...
        /// <summary>读取控制卡硬件的固件版本（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>读取控制卡动态库版本（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>读取指定卡轴数（适用于所有脉冲卡）</summary>
...
        /// <summary>获取本地IO点数（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>获取本地ADDA输入输出数（适用于所有脉冲卡）</summary>
...
        /// <summary>读取指定卡插补坐标系数（保留）</summary>
...
        /// <summary>密码函数（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>登入sn20191101（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_enter_password_ex(UInt16 CardNo, string str_pass);

        // ------------------- 运动模块脉冲模式 -------------------
        /// <summary>脉冲模式（适用于所有脉冲卡）</summary>
...
        /// <summary>脉冲当量（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>反向间隙(脉冲)（适用于DMC5000系列脉冲卡）</summary>
...
        /// <summary>下载内存文件 总线卡（适用于EtherCAT总线卡）</summary>
...
        /// <summary>上传内存文件（适用于EtherCAT总线卡）</summary>
...
        /// <summary>下载固件文件（适用于所有脉冲/总线卡）</summary>
...
        // ------------------- 限位异常设置 -------------------
        /// <summary>设置读取软限位参数（适用于E3032总线卡、R3032总线卡、DMC3000/5000/5X10系列脉冲卡）</summary>
...
        /// <summary>设置读取软限位参数unit（适用于DMC5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置读取EL信号（适用于所有脉冲卡）</summary>
...
        /// <summary>设置读取EMG信号（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>外部减速停止信号及减速停止时间设置，毫秒为单位（保留）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_dstp_mode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>外部减速停止信号及减速停止时间读取，毫秒为单位（保留）</summary>
...
        /// <summary>外部减速停止信号及减速停止时间设置，秒为单位（适用于所有脉冲卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_io_dstp_mode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>外部减速停止信号及减速停止时间读取，秒为单位（适用于所有脉冲卡）</summary>
...
        /// <summary>点位运动减速停止时间设置读取（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>IO减速停止，支持pmove/vmove运动（适用于DMC3000、DMC5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>速度设置(脉冲当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>速度读取(脉冲当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>速度曲线设置，加速度值表示(脉冲)（适用于所有脉冲卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_acc_profile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>速度曲线读取，加速度值表示(脉冲)（适用于所有脉冲卡）</summary>
...
        /// <summary>速度曲线设置，加速度值表示(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>速度曲线读取，加速度值表示(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>设置读取平滑速度曲线参数（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>点位运动(脉冲)（适用于所有脉冲卡）</summary>
...
        /// <summary>点位运动(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>指定轴做定长位移运动 同时发送速度和S时间(脉冲)（适用于DMC5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>在线变位(脉冲)，运动中改变目标位置（适用于所有脉冲卡）</summary>
...
        /// <summary>变速变位(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>在线变速(脉冲)，运动中改变指定轴的当前运动速度（适用于所有脉冲卡）</summary>
...
        /// <summary>在线变速(当量)，运动中改变指定轴的当前运动速度（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>无论运动与否强行改变目标位置（适用于所有脉冲卡）</summary>
...
        /// <summary>强行变位扩展（适用于DMC5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        // ------------------- JOG运动 -------------------
        /// <summary>单轴连续速度运动（适用于所有脉冲/总线卡）</summary>
...
        // ------------------- 插补运动 -------------------
        /// <summary>插补速度设置(脉冲)（适用于DMC3000系列脉冲卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_vector_profile_multicoor", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>插补速度读取(脉冲)（适用于DMC3000系列脉冲卡）</summary>
...
        /// <summary>设置读取平滑速度曲线参数（适用于DMC3000系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>插补速度参数(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>设置平滑速度曲线参数（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_vector_s_profile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>读取平滑速度曲线参数（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>直线插补运动（适用于DMC3000系列脉冲卡）</summary>
...
        /// <summary>圆弧插补运动（适用于DMC3000系列脉冲卡）</summary>
...
        /// <summary>直线插补(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>圆心圆弧插补(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>半径圆弧插补(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>三点圆弧插补(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>矩形插补(当量)（适用于EtherCAT总线卡、RTEX总线卡、DMC5000/5X10系列脉冲卡）</summary>
...
        // ------------------- PVT运动 -------------------
        /// <summary>PVT运动旧版 （适用于所有脉冲卡）</summary>
...
        /// <summary>设定读取指定轴的回原点模式（适用于所有脉冲卡）</summary>
...
        /// <summary>设置读取回零速度参数（适用于Rtex总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取原点锁存标志（适用于所有脉冲卡）</summary>
...
        /// <summary>清除原点锁存标志（适用于所有脉冲卡）</summary>
...
        /// <summary>读取原点锁存值（适用于所有脉冲卡）</summary>
...
        /// <summary>读取原点锁存值（unit）（适用于DMC5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置读取单轴手轮脉冲信号的工作方式（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>设置读取单轴手轮脉冲信号的工作方式，浮点型倍率（适用于DMC5X10系列脉冲卡）</summary>
...
        /// <summary>设置读取多轴手轮脉冲信号的工作方式（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>启动手轮运动（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>设置读到锁存方式（适用于所有脉冲卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_latch_mode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>读取读到锁存方式（适用于所有脉冲卡）</summary>
...
        /// <summary>读取编码器锁存器的值（适用于所有脉冲卡）</summary>
...
        /// <summary>复位锁存器标志（适用于所有脉冲卡）</summary>
...
        /// <summary>按索引取值（适用DMC3000系列脉冲卡）</summary>
...
        /// <summary>读取锁存个数（适用DMC3000系列脉冲卡）</summary>
...
        /// <summary>设置读取LTC反相输出（适用于所有脉冲卡）</summary>
...
        /// <summary>LTC端口触发延时急停时间 单位us（适用于所有脉冲卡）</summary>
...
        /// <summary>清除所有比较点（适用于所有脉冲/总线卡）</summary>
...
        /// <summary>添加比较点（适用于所有脉冲卡）</summary>
...
        /// <summary>添加比较点（适用于所有DMC5X10脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>添加比较点（适用于E3032/R3032）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>添加比较点unit（适用于E5032）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取当前比较点（适用于所有脉冲卡、Rtex总线卡、E3032卡）</summary>
...
        /// <summary>查询可以加入的比较点数量（适用于所有脉冲/总线卡）</summary>
...
        // ------------------- 二维低速位置比较 -------------------
        /// <summary>配置读取比较器（适用于所有脉冲卡、EtherCAT总线卡）</summary>
...
        /// <summary>清除所有比较点（适用于所有脉冲卡、EtherCAT总线卡）</summary>
...
        /// <summary>添加两轴位置比较点（适用于所有脉冲卡）</summary>
...
        /// <summary>读取当前比较点（适用于所有脉冲卡、EtherCAT总线卡）</summary>
...
        /// <summary>读取当前比较点unit（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_compare_get_current_point_extern_unit(UInt16 CardNo, double[] pos);
        /// <summary>添加两轴位置比较点（适用于DMC5X10脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>添加二维低速位置比较点（适用于EtherCAT总线系列卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>查询已经比较过的点（适用于所有脉冲卡、EtherCAT总线卡）</summary>
...
        /// <summary>查询可以加入的比较点数量（适用于所有脉冲卡、EtherCAT总线卡）</summary>
...
        // ------------------- 单轴高速位置比较 -------------------
        /// <summary>设置读取高速比较模式（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>设置高速比较参数（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>添加比较点（适用于所有脉冲卡、E3032总线卡、R3032总线卡）</summary>
...
        /// <summary>添加比较点unit（适用于DMC5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_add_point_unit(UInt16 CardNo, UInt16 hcmp, double cmp_pos);
        /// <summary>设置读取线性模式参数（适用于所有脉冲卡、E3032总线卡、R3032总线卡）</summary>
...
        /// <summary>读取高速比较状态（适用于DMC5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>清除比较点（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>读取指定CMP端口的电平（保留）</summary>
...
        /// <summary>配置读取二维高速比较器（适用于DMC5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取二维高速比较参数（适用于所有脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取二维高速比较参数（适用于DMC5X10系列脉冲卡、EtherCAT总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        // ------------------- 通用IO -------------------
        /// <summary>读取输入口的状态（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>设置输出口的状态（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>读取输出口的状态（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>读取输入端口的值（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>读取输出端口的值（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>设置所有输出端口的值（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>读取虚拟输入口的状态（适用于所有脉冲卡）</summary>
...
        /// <summary>IO延时翻转（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>设置读取IO计数模式（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>设置IO计数值（适用于所有脉冲卡、总线卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_io_count_value", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>读取IO计数值（适用于所有脉冲卡、总线卡）</summary>
...
        // ------------------- 专用IO 脉冲卡专用 -------------------
        /// <summary>设置读取轴IO映射关系（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>设置所有专用IO滤波时间（适用于所有脉冲卡）</summary>
...
        /// <summary>回原点减速信号配置，(DMC3410专用)</summary>
...
        /// <summary>设置读取INP信号（适用于所有脉冲卡）</summary>
...
        /// <summary>设置读取ALM信号（适用于所有脉冲卡）</summary>
...
        /// <summary>设置读取EZ信号（适用于所有脉冲卡）</summary>
...
        /// <summary>输出读取SEVON信号（适用于所有脉冲卡）</summary>
...
        /// <summary>控制ERC信号输出（适用于所有脉冲卡）</summary>
...
        /// <summary>读取RDY状态（适用于所有脉冲卡）</summary>
...
        /// <summary>编码器值(当量)（适用于DMC5000/5X10系列脉冲卡、所有总线卡）</summary>
...
        // ------------------- 辅助编码器 总线卡 -------------------
        /// <summary>手轮编码器（备用，同dmc_set_extra_encoder）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>当前位置(脉冲)（适用于所有脉冲卡）</summary>
...
        // ------------------- 运动状态 -------------------
        /// <summary>读取指定轴的当前速度（适用于所有脉冲卡）</summary>
...
        /// <summary>读取当前速度(当量)（适用于DMC5000/5X10系列脉冲卡、所有总线卡）</summary>
...
        /// <summary>读取指定轴的目标位置(当量)（适用于DMC5X10系列脉冲卡、所有EtherCAT总线系列卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_target_position_unit(UInt16 CardNo, UInt16 axis, ref double pos);
        /// <summary>读取指定轴的运动状态（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>读取指定轴有关运动信号的状态（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>停止插补器（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>紧急停止所有轴（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>脉冲卡指令 主卡与接线盒通讯状态（适用于所有脉冲卡）</summary>
...
        /// <summary>读取指定轴的运动模式（适用于DMC5000/5X10系列脉冲卡、所有总线卡）</summary>
...
        /// <summary>读取轴停止原因（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>清除轴停止原因（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>trace功能（内部使用函数）</summary>
...
        // ------------------- CAN-IO扩展 -------------------
        /// <summary>CAN-IO扩展，旧接口函数（保留）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_can_state", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>读取can errcode extern</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取CAN io输入（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置CAN io输出32位（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取CAN io输出32位（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取CAN io输入32位（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>配置CAN DA模式（适用于所有脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取CAN AD参数（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>配置CAN AD模式（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>配置CAN DA模式（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>关闭连续缓存区（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>复位连续缓存区（预留）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_conti_reset_list(UInt16 CardNo, UInt16 Crd);
        /// <summary>连续插补中停止（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补中暂停（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>开始连续插补（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>检测连续插补运动状态：0-运行，1-暂停，2-正常停止（DMC5X10不支持），3-未启动，4-空闲（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>检测连续插补运动状态：0-运行，1-停止（预留）</summary>
...
        /// <summary>查连续插补剩余缓存数（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>读取当前连续插补段的标号（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>blend拐角过度模式（适用于DMC5000系列脉冲卡）</summary>
...
        /// <summary>设置每段速度比例  缓冲区指令（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>设置插补中动态变速（适用于DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>小线段前瞻（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        // ------------------- 连续插补IO功能 -------------------
        /// <summary>等待IO输入（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>相对于轨迹起点IO滞后输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>相对于轨迹终点IO滞后输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>相对于轨迹终点IO提前输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补精确位置CMP输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补立即IO输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>清除段内未执行完的IO（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补暂停及异常时IO输出状态（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>延时指令（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补直线插补（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补圆心圆弧插补（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补半径圆弧插补（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补3点圆弧插补（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补矩形插补（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>设置螺旋线插补运动模式（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>设置读取龙门跟随模式（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置读取PWM使能（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>设置读取PWM立即输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补PWM输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>设置PWM开关对应的占空比（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_pwm_onoff_duty", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>读取PWM开关对应的占空比（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补PWM速度跟随（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补相对轨迹起点PWM滞后输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补相对轨迹终点PWM提前输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        /// <summary>连续插补PWM立即输出（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        // ------------------- ADDA输出 -------------------
        /// <summary>控制卡接线盒DA输出，设置DA输出使能（适用于所有脉冲卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_da_enable", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>控制卡接线盒DA输出，读取DA输出使能（适用于所有脉冲卡）</summary>
...
        /// <summary>设置DA输出（适用于所有脉冲卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_da_output", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>读取DA输出（适用于所有脉冲卡）</summary>
...
        /// <summary>连续插补DA速度跟随（适用于DMC5000/5X10系列脉冲卡）</summary>
...
        /// <summary>小圆限速使能（适用于DMC5000/5X10系列脉冲卡、E5032总线卡）</summary>
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置interlock enable</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_interlock_enable(UInt16 CardNo, UInt16 enable);
        /// <summary>龙门模式的误差保护（适用于DMC5000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>龙门模式的误差保护当量函数（适用于DMC5000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取坐标系各轴的当前规划坐标（保留）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>配置逻辑补偿参数（当量）（适用于DMC5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置/回读脉冲计数值和编码器反馈值之间差值的报警阈值unit（适用于DMC5X10脉冲卡、EtherCAT总线卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_pulse_encoder_count_error_unit(ushort CardNo, ushort axis, double error);
        /// <summary>读取/回读脉冲计数值和编码器反馈值之间差值的报警阈值unit（适用于DMC5X10脉冲卡、EtherCAT总线卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_pulse_encoder_count_error_unit(ushort CardNo, ushort axis, ref double error);
        /// <summary>检查脉冲计数值和编码器反馈值之间差值是否超过报警阈值unit（适用于DMC5X10脉冲卡、EtherCAT总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置位置误差带（适用于所有脉冲卡、总线卡）</summary>
        [DllImport("LTDMC.dll", EntryPoint = "dmc_set_factor_error", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>读取位置误差带（适用于所有脉冲卡、总线卡）</summary>
...
        /// <summary>设置/回读位置误差带unit（适用于DMC5X10脉冲卡、EtherCAT总线卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_factor_error_unit(ushort CardNo, ushort axis, double factor, double error);
        /// <summary>读取/回读位置误差带unit（适用于DMC5X10脉冲卡、EtherCAT总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll", EntryPoint = "nmc_download_mapfile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>读取manager para</summary>
        ...
        /// <summary>读取LostHeartbeat Nodes</summary>
        ...
        /// <summary>读取EmergeneyMessege Nodes</summary>
...
         * *para_data:读出的参数值
         * **************************************************************/
        /// <summary>读取parameter attributes</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>写入rxpdo extra uint</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取rxpdo extra uint</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取txpdo extra uint</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置编码器方向（适用于DMC3000系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_set_encoder_dir(UInt16 CardNo, UInt16 axis, UInt16 dir);

        /// <summary>圆弧区域软限位（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>圆形区域软限位unit（适用于DMC5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>查询相应轴的状态（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_arc_zone_limit_axis_status(UInt16 CardNo, UInt16 axis);
        /// <summary>圆形限位使能（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        // ------------------- ORG输入触发在线变速变位 -------------------
        /// <summary>配置ORG输入触发在线变速变位（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取pmove change pos speed config</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>获取指定坐标系切向跟随参数（适用于DMC5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>取消坐标系跟随（适用于DMC5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_disable_follow_move(UInt16 CardNo, UInt16 Crd);
        /// <summary>椭圆插补（适用于DMC5X10系列脉冲卡、E5032总线卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>复位看门狗定时器（适用于DMC3000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_reset_watchdog_timer(UInt16 CardNo);

        /// <summary>io定制功能（定制类）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>螺旋插补(测试使用，DMC5000/5X10系列脉冲卡、E5032总线卡)</summary>
        [DllImport("LTDMC.dll")]
...
        // ------------------- 指令缓存门型运动 -------------------
        /// <summary>指令缓存门型运动（适用于DMC3000/5000系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>添加多轴位置触发双段运动数据</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>添加IO+位置触发运动段数据</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>添加IO+位置触发双段运动数据</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>添加IO+位置触发下降段数据</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>添加IO+位置触发下降双段数据</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>添加位置触发下降双段指令数据</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>添加多轴位置触发单轴下降段数据</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>添加多轴位置触发多轴下降段数据</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>连续插补vmove（DMC5000系列卡受限使用）</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>读取运行时是启动正常固件还是备份固件（适用于DMC3000/5000/5X10系列脉冲卡）</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_conti_arc_move_3points_section_unit(ushort CardNo, ref ushort boot_type);

        // ------------------- 中断功能（适用于DMC5X10系列脉冲卡） -------------------
        /// <summary>开启控制卡中断功能</summary>
        [DllImport("LTDMC.dll")]
        public static extern uint dmc_int_enable(ushort CardNo, DMC3K5K_OPERATE funcIntHandler, IntPtr operate_data);
        /// <summary>禁止控制卡的中断</summary>
        [DllImport("LTDMC.dll")]
        public static extern uint dmc_int_disable(ushort CardNo);
        /// <summary>设置/读取指定控制卡中断通道使能</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置/读取指定控制卡中断配置</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>设置profile extern</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取profile extern</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置vector profile limit</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取vector profile limit</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取m move config</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>TypeIndex:0~6  m_Averagetime ; 平均时间 m_Maxtime;最大时间 uint64  m_Cycles;当前时间</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置axis contrlmode</summary>
...
        //PVT_continuous接口.
        /// <summary>下发PVT continuous各节点数据</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>反馈位置误差允许范围设置</summary>
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_set_encoder_error_allow(ushort CardNo, ushort group, double allow_error);
        /// <summary>相对轨迹起点IO滞后输出(路径模式)</summary>
        ...
        /// <summary>相对轨迹终点IO滞后输出(路径模式)</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>相对轨迹终点IO提前输出(路径模式)</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取ad monitor config</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取ad monitor result</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>指定轴做定长位移运动 同时发送速度和S时间(当量)</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置profile limit unit</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置vector profile limit unit</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取vector profile limit unit</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取conti smooth contour curve</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取cam in status</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取gap cmp param</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取mc gearin status</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取mc gear out status</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取mc combine axes</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取mc combine axes status</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置space collision zone param</summary>
        ...
        /// <summary>读取space collision zone param</summary>
        [DllImport("LTDMC.dll")]
...
        /// <summary>回读pmove运动规划总时间及剩余时间</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取apf rotary cut init</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取apf rotary cut init status</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取apf rotary cut in status</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>写入rxpdo extra short</summary>
        ...
        /// <summary>读取rxpdo extra short</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取txpdo extra short</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取mc gear in pos</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取mc gear in pos status</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置ez map input</summary>
        ...
        /// <summary>读取ez map input</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置etc el stop mode</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置acuate angle config params</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取acuate angle config params</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置pos calibrate config</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取pos calibrate config</summary>
        [DllImport("LTDMC.dll")]
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取home finish map</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取config error info</summary>
...
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取idle crd index</summary>
        ...
        /// <summary>读取position virtual</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置check target encoder</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取check target encoder</summary>
        ...
        /// <summary>设置check inp encoder</summary>
        ...
        /// <summary>读取check inp encoder</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取robot config</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取robot kinematics calib</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置robot user coordinate</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取robot user coordinate</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置robot tool coordinate</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取robot tool coordinate</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置pwm output extern</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取vector profile extern</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>写入EtherCAT从站寄存器</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置inp map input</summary>
        ...
        /// <summary>读取inp map input</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取mc phasing status</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置axis pwm follow speed</summary>
        ...
        /// <summary>读取axis pwm follow speed</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置axis da follow speed</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取axis da follow speed</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>设置axis da follow speed extern</summary>
        ...
        /// <summary>读取axis da follow speed extern</summary>
        [DllImport("LTDMC.dll")]
        ...
        /// <summary>读取feedforward profile</summary>
        [DllImport("LTDMC.dll")]
