...
namespace PF.WorkStation.AutoOcr.Mechanisms
{
    ...
    public class WorkStation2FeedingModule : BaseMechanism
    {
        ...
        /// 实例化晶圆上料模组
        /// </summary>
        public WorkStation2FeedingModule(IHardwareManagerService hardwareManagerService, IParamService paramService, ILogService logger)
        ...
        public async Task<bool> CanMoveXAxesAsync(CancellationToken token = default)
        {
            ...
            if (_io.ReadInput(E_InPutName.晶圆夹爪右气缸张开) != true)
            {
