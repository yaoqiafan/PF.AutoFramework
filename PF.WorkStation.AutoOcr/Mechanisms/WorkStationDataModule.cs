...
namespace PF.WorkStation.AutoOcr.Mechanisms
{
    ...
    public class WorkStationDataModule : BaseMechanism
    {
        ...
        /// </summary>
        [JsonInclude]
        private ObservableCollection<MachineDetectionData> _Sation1MachineDetectionData =
            new ObservableCollection<MachineDetectionData>();

        public ObservableCollection<MachineDetectionData> Sation1MachineDetectionData =>
        ...
        /// </summary>
        [JsonInclude]
        private ObservableCollection<MachineDetectionData> _Sation2MachineDetectionData =
            new ObservableCollection<MachineDetectionData>();

        public ObservableCollection<MachineDetectionData> Sation2MachineDetectionData =>
        ...
        /// </summary>
        [JsonInclude]
        private ObservableCollection<MachineDetectionData> _AllMachineDetectionData =
            new ObservableCollection<MachineDetectionData>();

        public ObservableCollection<MachineDetectionData> AllMachineDetectionData =>
        ...
        private class WorkStationDataModuleSnapshot
        {
            ...
            public ObservableCollection<MachineDetectionData> Sation1MachineDetectionData { get; set; } =
                new ObservableCollection<MachineDetectionData>();

            public ObservableCollection<MachineDetectionData> Sation2MachineDetectionData { get; set; } =
                new ObservableCollection<MachineDetectionData>();

            public ObservableCollection<MachineDetectionData> AllMachineDetectionData { get; set; } =
                new ObservableCollection<MachineDetectionData>();
